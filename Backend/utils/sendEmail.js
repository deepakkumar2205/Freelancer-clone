    ...
    try {
        ...
        const info= await transporter.sendMail({
            ...
            <div className="border" style="height: 300px; width: 400px; border: 3px solid black; padding: 10px; border-radius: 15px;">
                <h1 style="background-color: black; color: white; border: 3px solid black; border-radius: 15px 15px 0 0; display:flex;     align-items: center !important; margin:0px"><img style="width: 50px; padding: 5px; margin-left: 13px;" src="https://cdn.icon-icons.com/icons2/2699/PNG/512/freelancer_logo_icon_171122.png" alt=""> 
                <span style="display:flex; padding-top: 11px;">Freelancers</span>
                </h1>
                <h3>${subject}</h3>
                <hr>
